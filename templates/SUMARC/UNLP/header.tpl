...
<div style="text-align: center;">
    <div style="font-weight: bold; color: rgb(49, 132, 155); font-size: 0.9em; font-family: 'Helvetica';">
    ...
    <div>
        <a style="color: rgb(49, 132, 155); text-decoration: none; font-size: 0.9em; word-break: break-all; font-family: 'Helvetica';
