...
6. La nueva clase creada debe definir los métodos: `formatSingleAuthorCitation`, `formatTwoAuthorsCitation`, `formatMultipleAuthorsCitation` y `getCitationSeparator`.
   ...
   - **getCitationSeparator** define el separador que habrá entre una cita y otra. Por ejemplo, si queremos citar 2 referencias o más en APA, el separador será un ";". Por ejemplo: `(Apellido1 y Apellido2, 2025; Apellido3, 2010; Apellido4, 2022)`. En este ejemplo se están citando 3 referencias, una con 2 autores, una con un solo autor y otra con un único autor. Además, cada cita está separada con un ";".
...
**ACLARACIÓN:** Desde la clase TableHTML se instancia la clase correspondiente al estilo de cita que se está utilizando pasandole los parámetros especificados en el punto 7, pero el constructor que se ejecuta es el de GenericCitationTable. 
